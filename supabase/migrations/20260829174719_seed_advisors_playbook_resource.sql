-- Move the original Advisor's Playbook from the frontend fallback catalog into
-- the editable resource table. Existing rows win so a migration replay never
-- overwrites changes made later through Cresciva Studio.
...
values (
  'The Advisor''s Playbook: Build a Winning Business Plan',
  'the-advisors-playbook',
  'playbook',
  'Business planning',
  'A practical blueprint for turning your business model into a plan that attracts grants, investors and the right partners.',
  $resource$
...
Open the full workshop deck after signing in to work through the exercise.
  ...
  'The Advisor''s Playbook · Google Slides',
  array['Business planning', 'Business model canvas', 'Grants', 'Investors'],
  true,
  'published',
  true,
  25,
